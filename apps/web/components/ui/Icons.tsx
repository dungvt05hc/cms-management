...
export const StarIcon: React.FC<IconProps & { filled?: boolean }> = ({ size = 24, color = 'currentColor', className, filled }) => (
...
export const GridIcon: React.FC<IconProps> = ({ size = 24, color = 'currentColor', className }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
